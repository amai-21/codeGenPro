...
void levelOrderRec(node_t*, root, string::size_type treeLevel, vector<vector<int>>& res){
...
void traversePreOrder(node_t* root, string::size_type treeLevel){
	...
	traversePreOrder(root->left, treeLevel + 1);
	traversePreOrder(root->right, treeLevel + 1);
}
